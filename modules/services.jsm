...
let EXPORTED_SYMBOLS = ['log', 'minimizeWindow', 'restoreWindow', 'restoreAll', 'watchWindow', 'unwatchWindow'];
...
const trayService = Cc['@tn123.ath.cx/trayservice;1'].getService(Ci.trayITrayService);
